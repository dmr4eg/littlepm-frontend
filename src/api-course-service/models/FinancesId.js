...
/**
 * The FinancesId model module.
 * @module api-course-service/models/FinancesId
 * @version 1.0.0
 */
class FinancesId {
    /**
     * Constructs a new <code>FinancesId</code>.
     * Composite ID for Finances
     * @alias module:api-course-service/models/FinancesId
    ...
    constructor(projectBlueprintUuid, userUuid) { 
        ...
        FinancesId.initialize(this, projectBlueprintUuid, userUuid);
    }
    ...
    /**
     * Constructs a <code>FinancesId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:api-course-service/models/FinancesId} obj Optional instance to populate.
     * @return {module:api-course-service/models/FinancesId} The populated <code>FinancesId</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FinancesId();
    ...
    /**
     * Validates the JSON data with respect to <code>FinancesId</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FinancesId</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FinancesId.RequiredProperties) {
...
FinancesId.RequiredProperties = ["project_blueprint_uuid", "user_uuid"];

/**
 * UUID for a Project Blueprint
 * @member {String} project_blueprint_uuid
 */
FinancesId.prototype['project_blueprint_uuid'] = undefined;

/**
 * UUID for a User
 * @member {String} user_uuid
 */
FinancesId.prototype['user_uuid'] = undefined;
