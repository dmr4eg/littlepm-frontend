 ...
 * @module api-course-service/models/DayDTO
 * @version 1.0.0
 */
class DayDTO {
    /**
     * Constructs a new <code>DayDTO</code>.
     * @alias module:api-course-service/models/DayDTO
     * @param blueprint {module:api-course-service/models/DayBlueprint} 
     * @param instance {module:api-course-service/models/DayInstance} 
     */
     ...
     * @param {module:api-course-service/models/DayDTO} obj Optional instance to populate.
     * @return {module:api-course-service/models/DayDTO} The populated <code>DayDTO</code> instance.
     */
...
/**
 * @member {module:api-course-service/models/DayBlueprint} blueprint
 */
DayDTO.prototype['blueprint'] = undefined;

/**
 * @member {module:api-course-service/models/DayInstance} instance
 */
