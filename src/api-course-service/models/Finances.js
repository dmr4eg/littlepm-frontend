 ...
 * @module api-course-service/models/Finances
 * @version 1.0.0
 */
class Finances {
    /**
     ...
     * @alias module:api-course-service/models/Finances
     * @param id {module:api-course-service/models/FinancesId} 
     */
    constructor(id) { 
     ...
     * @param {module:api-course-service/models/Finances} obj Optional instance to populate.
     * @return {module:api-course-service/models/Finances} The populated <code>Finances</code> instance.
     */
...
/**
 * @member {module:api-course-service/models/FinancesId} id
 */
