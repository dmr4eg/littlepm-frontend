 ...
 * @module api-course-service/models/ProjectBlueprint
 * @version 1.0.0
 */
class ProjectBlueprint {
    /**
     * Constructs a new <code>ProjectBlueprint</code>.
     * @alias module:api-course-service/models/ProjectBlueprint
     ...
     * @param {module:api-course-service/models/ProjectBlueprint} obj Optional instance to populate.
     * @return {module:api-course-service/models/ProjectBlueprint} The populated <code>ProjectBlueprint</code> instance.
     */
...
/**
 * @member {module:api-course-service/models/ProjectBlueprint.DifficultyEnum} difficulty
 */
ProjectBlueprint.prototype['difficulty'] = undefined;

/**
 * @member {module:api-course-service/models/ProjectBlueprint.StyleEnum} style
 */
