...
/**
* @module api-content-service/ApiClient
* @version 1.0.0
*/
...
* @alias module:api-content-service/ApiClient
* @class
*/
class ApiClient {
    /**
    ...
    constructor(basePath = 'https://api.example.com') {
        ...
        this.authentications = {
            'admin_jwt': {type: 'bearer'}, // JWT
            'user_jwt': {type: 'bearer'} // JWT
        }
    ...
    * @param {module:api-content-service/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
    ...
    * @callback module:api-content-service/ApiClient~callApiCallback
    ...
    * @param {module:api-content-service/ApiClient~callApiCallback} callback The callback function.
...
* @type {module:api-content-service/ApiClient}
*/
