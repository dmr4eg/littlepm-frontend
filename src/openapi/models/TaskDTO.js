 ...
 * @module openapi/models/TaskDTO
 * @version 1.0.0
 */
class TaskDTO {
    /**
     * Constructs a new <code>TaskDTO</code>.
     * @alias module:openapi/models/TaskDTO
     * @param blueprint {module:openapi/models/TaskBlueprint} 
     * @param progress {module:openapi/models/TaskInstance} 
     */
     ...
     * @param {module:openapi/models/TaskDTO} obj Optional instance to populate.
     * @return {module:openapi/models/TaskDTO} The populated <code>TaskDTO</code> instance.
     */
...
/**
 * @member {module:openapi/models/TaskBlueprint} blueprint
 */
TaskDTO.prototype['blueprint'] = undefined;

/**
 * @member {module:openapi/models/TaskInstance} progress
 */
