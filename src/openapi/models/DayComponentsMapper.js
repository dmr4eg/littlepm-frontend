 ...
 * @module openapi/models/DayComponentsMapper
 * @version 1.0.0
 */
class DayComponentsMapper {
     ...
     * @alias module:openapi/models/DayComponentsMapper
     * @param id {module:openapi/models/DayComponentsMapperId} 
     * @param type {module:openapi/models/DayComponentsMapper.TypeEnum} 
     ...
     * @param {module:openapi/models/DayComponentsMapper} obj Optional instance to populate.
     * @return {module:openapi/models/DayComponentsMapper} The populated <code>DayComponentsMapper</code> instance.
     */
...
/**
 * @member {module:openapi/models/DayComponentsMapperId} id
 */
DayComponentsMapper.prototype['id'] = undefined;

/**
 * @member {module:openapi/models/DayComponentsMapper.TypeEnum} type
 */
