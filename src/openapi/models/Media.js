 ...
 * @module openapi/models/Media
 * @version 1.0.0
 */
class Media {
    /**
     * Constructs a new <code>Media</code>.
     * @alias module:openapi/models/Media
     * @param mediaUUID {String} UUID for a Media resource
     * @param type {module:openapi/models/Media.TypeEnum} 
     * @param title {String} 
     */
     ...
     * @param {module:openapi/models/Media} obj Optional instance to populate.
     * @return {module:openapi/models/Media} The populated <code>Media</code> instance.
     */
...
/**
 * @member {module:openapi/models/Media.TypeEnum} type
 */
