...
* @alias module:openapi/ApiClient
* @class
*/
class ApiClient {
    /**
    ...
    * @param {module:openapi/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
    ...
    * @callback module:openapi/ApiClient~callApiCallback
    ...
    * @param {module:openapi/ApiClient~callApiCallback} callback The callback function.
