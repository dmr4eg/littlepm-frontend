 ...
 * @module openapi/models/FormInstance
 * @version 1.0.0
 */
class FormInstance {
    /**
     ...
     * @alias module:openapi/models/FormInstance
     * @param id {module:openapi/models/FormInstanceId} 
     ...
     * @param {module:openapi/models/FormInstance} obj Optional instance to populate.
     * @return {module:openapi/models/FormInstance} The populated <code>FormInstance</code> instance.
     */
...
/**
 * @member {module:openapi/models/FormInstanceId} id
 */
