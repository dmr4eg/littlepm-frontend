 ...
 * @module openapi/models/FinancesId
 * @version 1.0.0
 */
class FinancesId {
    /**
     ...
     * @alias module:openapi/models/FinancesId
     ...
     * @param {module:openapi/models/FinancesId} obj Optional instance to populate.
     * @return {module:openapi/models/FinancesId} The populated <code>FinancesId</code> instance.
     */
