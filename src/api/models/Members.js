...
class Members {
     ...
     * @alias module:openapi/models/Members
     * @param id {module:openapi/models/MembersId} 
     ...
     * @param {module:openapi/models/Members} obj Optional instance to populate.
     * @return {module:openapi/models/Members} The populated <code>Members</code> instance.
     */
...
/**
 * @member {module:openapi/models/MembersId} id
 */
